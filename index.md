...
<section class="content markdown">
	<h1 class="!text-8xl sm:!text-9xl"><span class="text-secondary-500 font-bold">></span>xon<br> dis<br>.net</h1>

<p class="text-xl"><b>welcome</b> to my little corner of the web<i>!</i><br>thank you for stopping by! i use this to host a few things here.</p>
</section>